            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addItem(subjectInput, setSubjects, setSubjectInput))}
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {subjects.map((subject, idx) => (
                  <span key={idx} className="px-3 py-1 bg-sky-600/30 text-sky-200 rounded-full text-sm flex items-center gap-2">
                    {subject}
                    <button onClick={() => removeItem(idx, setSubjects)} className="hover:text-red-400">×</button>
                  </span>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addItem(interestInput, setInterests, setInterestInput))}
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {interests.map((interest, idx) => (
                  <span key={idx} className="px-3 py-1 bg-purple-600/30 text-purple-200 rounded-full text-sm flex items-center gap-2">
                    {interest}
                    <button onClick={() => removeItem(idx, setInterests)} className="hover:text-red-400">×</button>
                  </span>
                ))}
              </div>
            </div>
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {hobbies.map((hobby, idx) => (
                  <span key={idx} className="px-3 py-1 bg-purple-600/30 text-purple-200 rounded-full text-sm flex items-center gap-2">
                    {hobby}
                    <button onClick={() => removeItem(idx, setHobbies)} className="hover:text-red-400">×</button>
                  </span>
                ))}
              </div>
            </div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {sportsActivities.map((sport, idx) => (
                  <span key={idx} className="px-3 py-1 bg-green-600/30 text-green-200 rounded-full text-sm flex items-center gap-2">
                    {sport}
                    <button onClick={() => removeItem(idx, setSportsActivities)} className="hover:text-red-400">×</button>
                  </span>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addItem(academicChallengeInput, setAcademicChallenges, setAcademicChallengeInput))}
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {academicChallenges.map((challenge, idx) => (
                  <span key={idx} className="px-3 py-1 bg-orange-600/30 text-orange-200 rounded-full text-sm flex items-center gap-2">
                    {challenge}
                    <button onClick={() => removeItem(idx, setAcademicChallenges)} className="hover:text-red-400">×</button>
                  </span>
                ))}
              </div>
            </div>
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addItem(personalChallengeInput, setPersonalChallenges, setPersonalChallengeInput))}
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {personalChallenges.map((challenge, idx) => (
                  <span key={idx} className="px-3 py-1 bg-orange-600/30 text-orange-200 rounded-full text-sm flex items-center gap-2">
                    {challenge}
                    <button onClick={() => removeItem(idx, setPersonalChallenges)} className="hover:text-red-400">×</button>
                  </span>
                ))}
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1">Any mental health concerns? (optional, confidential)</label>
              <textarea
    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-slate-900 via-slate-800 to-sky-900">
      <div className="w-full max-w-2xl p-8 space-y-6 bg-slate-800 rounded-2xl shadow-2xl shadow-sky-900/50">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">Step {step} of {totalSteps}</p>
        </div>
